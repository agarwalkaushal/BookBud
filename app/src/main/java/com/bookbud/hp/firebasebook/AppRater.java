...
public class AppRater {
    private final static String APP_TITLE = "BookBud";// App Name
    private final static String APP_PNAME = "com.bookbud.hp.firebasebook";// Package Name
    ...
    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
        ...
        tv.setText("Enjoy using " + APP_TITLE + ", please take a moment to rate it!");
